...
<div class="row mb-1 border-bottom">
    <div class="col-sm-3 text-info border-right">希望利用機器</div><div class="col-sm-4"><?=$rsv['instrument_id']?></div>
</div>
<div class="row mb-1 border-bottom">
...
<div class="row mb-1 border-bottom">
    <div class="col-sm-2 text-info border-right">備考</div><div class="col-sm-9"></div></div>
</a>