...
/*** 「利用状況申請（R5）」に掲載された機器設備
ＸＰＳ	Ｘ線光電子分析装置
mini-ＳＥＭ	卓上電子顕微鏡
SEM	 多目的高分解能走査電子顕微鏡システム
ＥＡ	元素分析装置
ＸＲＤ	多目的X線回折測定システム
ＬＣＭＳ	マルチ高速液体クロマトグラフシステム
ＩＣＰ	ＩＣＰ発光分光分析装置
ＩＣ	イオンクロマトグラフ
ＡＡ	原子吸光分析システム
VE	高真空蒸着装置
...
ＴＧ/ＤＴＡ	ＴＧ/ＤＴＡガストランスファー分析システム
ＭＡＬＤＩ	マトリックス支援レーザー脱離イオン化飛行時間型質量分析計
ＣＰＩ	キュリーポイントインジェクター
ＴＧＭＳＩＲ	ＴＧ-ＤＳＣ-ＭＳ-ＦＴＩＲ 同時熱分析装置
Ｐｌａｍｉｎｏ	粉体大気圧プラズマ処理装置
超純水(LCMS･IC専用)	超純水製造システム
蒸留水	純水製造装置
ＣＤ	円二色性分散計 高速ストップドフローシステム
ＬＣＲ	ＬＣＲメータ
ＬＭＳ	環境情報測定解析システム
ＴＲＩＳＴＡＲ	自動比表面積/細孔分布測定装置
レオメータ	粘度粘弾性測定装置
ＦＬ	蛍光発光マイクロプレートリーダ
IRUV-camera	文化財赤外紫外線撮影装置
ＵＶ	紫外可視近赤外分光光度計
ＰＰＭＳ	極低温高磁場物性測定システム
遠心分離機	高速大容量冷却遠心機
ＧＡＭＭＡ	放射線測定器
ＬＬＷ	レーザー線幅測定器
Ｓ-ＮＭＲ	核磁気共鳴装置
ＭＰＭＳ３	ナノ材料高分解能磁気測定システム
MRI	筋骨格系専用立体MRIイメージング装置
サーベイメータ	電離箱式サーベイメータ
サーモグラフィー	赤外線サーモグラフカメラ
ＢＰ	ビジネスプロジェクター
